<template>
  <p
    v-if="landing"
    class="text_regular_18 text-darkGray dark:text-lightGray opacity-55 w-screen text-center px-5"
  >
    {{ $t("footer") }}
  </p>
...
const props = defineProps<{ landing: boolean }>();
</script>
